...
# torch.save(cgkn.state_dict(), r"Models/Model_KoopmanLinear/ENSO_KoopmanLinear_TH_12Months_3Loss_Normalized_dimz10_stage1.pt")
# np.save(r"Models/Model_KoopmanLinear/ENSO_KoopmanLinear_TH_12Months_3Loss_Normalized_dimz10_train_loss_forecast_history_stage1.npy", train_loss_forecast_history)
# np.save(r"Models/Model_KoopmanLinear/ENSO_KoopmanLinear_TH_12Months_3Loss_Normalized_dimz10_train_loss_ae_history_stage1.npy", train_loss_ae_history)
# np.save(r"Models/Model_KoopmanLinear/ENSO_KoopmanLinear_TH_12Months_3Loss_Normalized_dimz10_train_loss_forecast_z_history_stage1.npy", train_loss_forecast_z_history)

cgkn.load_state_dict(torch.load(r"Models/Model_KoopmanLinear/ENSO_KoopmanLinear_TH_12Months_3Loss_Normalized_dimz10_stage1.pt"))
...
# torch.save(cgkn.state_dict(), r"Models/Model_KoopmanLinear/ENSO_KoopmanLinear_TH_12Months_3Loss_Normalized_dimz10_stage2.pt")
# np.save(r"Models/Model_KoopmanLinear/ENSO_KoopmanLinear_TH_12Months_3Loss_Normalized_dimz10_train_loss_forecast_history_stage2.npy", train_loss_forecast_history)
# np.save(r"Models/Model_KoopmanLinear/ENSO_KoopmanLinear_TH_12Months_3Loss_Normalized_dimz10_train_loss_ae_history_stage2.npy", train_loss_ae_history)
# np.save(r"Models/Model_KoopmanLinear/ENSO_KoopmanLinear_TH_12Months_3Loss_Normalized_dimz10_train_loss_forecast_z_history_stage2.npy", train_loss_forecast_z_history)
# np.save(r"Models/Model_KoopmanLinear/ENSO_KoopmanLinear_TH_12Months_3Loss_Normalized_dimz10_train_loss_da_history_stage2.npy", train_loss_da_history)

cgkn.load_state_dict(torch.load(r"Models/Model_KoopmanLinear/ENSO_KoopmanLinear_TH_12Months_3Loss_Normalized_dimz10_stage2.pt"))
...
torch.save(uncertainty_net.state_dict(), r"Models/Model_KoopmanLinear/KoopmanLinear_UQNet_TH_12Months_3Loss_Normalized_dimz10.pt")
np.save(r"Models/Model_KoopmanLinear/KoopmanLinear_UQNet_TH_12Months_3Loss_Normalized_dimz10_train_loss_uncertainty_history.npy", train_loss_uncertainty_history)

# uncertainty_net.load_state_dict(torch.load(r"Models/Model_KoopmanLinear/KoopmanLinear_UQNet_TH_12Months_3Loss_Normalized_dimz10.pt"))
...
np.save(r"Data/KoopmanLinear_DA_mean.npy", test_mu_pred)
np.save(r"Data/KoopmanLinear_DA_std.npy", test_mu_std_pred)
