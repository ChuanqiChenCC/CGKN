...
# Koopman Linear Dynamics for Normalized Data with dimz = 10
...
class CGN(nn.Module):
    def __init__(self, dim_u1, dim_z):
        ...
        self.output_size = np.prod(self.f1_size) + np.prod(self.g1_size)
        ...
        self.f2_param = nn.Parameter(1/np.sqrt(np.prod(self.f2_size))*torch.randn(*self.f2_size))
        self.g2_param = nn.Parameter(1/np.sqrt(np.prod(self.g2_size))*torch.randn(*self.g2_size))
    def forward(self, x):
...
# torch.save(cgkn.state_dict(), path_abs + r"/Models/Model_KoopmanLinear/ENSO_KoopmanLinear_TH_12Months_3Loss_Normalized_dimz10_stage1.pt")
# np.save(path_abs + r"/Models/Model_KoopmanLinear/ENSO_KoopmanLinear_TH_12Months_3Loss_Normalized_dimz10_train_loss_forecast_history_stage1.npy", train_loss_forecast_history)
# np.save(path_abs + r"/Models/Model_KoopmanLinear/ENSO_KoopmanLinear_TH_12Months_3Loss_Normalized_dimz10_train_loss_ae_history_stage1.npy", train_loss_ae_history)
# np.save(path_abs + r"/Models/Model_KoopmanLinear/ENSO_KoopmanLinear_TH_12Months_3Loss_Normalized_dimz10_train_loss_forecast_z_history_stage1.npy", train_loss_forecast_z_history)

cgkn.load_state_dict(torch.load(path_abs + r"/Models/Model_KoopmanLinear/ENSO_KoopmanLinear_TH_12Months_3Loss_Normalized_dimz10_stage1.pt"))
...
# torch.save(cgkn.state_dict(), path_abs + r"/Models/Model_KoopmanLinear/ENSO_KoopmanLinear_TH_12Months_3Loss_Normalized_dimz10_stage2.pt")
# np.save(path_abs + r"/Models/Model_KoopmanLinear/ENSO_KoopmanLinear_TH_12Months_3Loss_Normalized_dimz10_train_loss_forecast_history_stage2.npy", train_loss_forecast_history)
# np.save(path_abs + r"/Models/Model_KoopmanLinear/ENSO_KoopmanLinear_TH_12Months_3Loss_Normalized_dimz10_train_loss_ae_history_stage2.npy", train_loss_ae_history)
# np.save(path_abs + r"/Models/Model_KoopmanLinear/ENSO_KoopmanLinear_TH_12Months_3Loss_Normalized_dimz10_train_loss_forecast_z_history_stage2.npy", train_loss_forecast_z_history)
# np.save(path_abs + r"/Models/Model_KoopmanLinear/ENSO_KoopmanLinear_TH_12Months_3Loss_Normalized_dimz10_train_loss_da_history_stage2.npy", train_loss_da_history)

cgkn.load_state_dict(torch.load(path_abs + r"/Models/Model_KoopmanLinear/ENSO_KoopmanLinear_TH_12Months_3Loss_Normalized_dimz10_stage2.pt"))
...
torch.save(uncertainty_net.state_dict(), path_abs + r"/Models/Model_KoopmanLinear/KoopmanLinear_UQNet_TH_12Months_3Loss_Normalized_dimz10.pt")
np.save(path_abs + r"/Models/Model_KoopmanLinear/KoopmanLinear_UQNet_TH_12Months_3Loss_Normalized_dimz10_train_loss_uncertainty_history.npy", train_loss_uncertainty_history)

# uncertainty_net.load_state_dict(torch.load(path_abs + r"/Models/Model_KoopmanLinear/KoopmanLinear_UQNet_TH_12Months_3Loss_Normalized_dimz10.pt"))
...
np.save(path_abs + r"/Data/KoopmanLinear_DA_mean.npy", test_mu_pred)
np.save(path_abs + r"/Data/KoopmanLinear_DA_std.npy", test_mu_std_pred)
