...
class CGN(nn.Module):
    def __init__(self, dim_u1, dim_u2, dim_z_unit):
        ...
        self.unitNet2_param = nn.Parameter( 1/np.sqrt(self.dim_z_unit + 5*self.dim_z_unit**2)*torch.randn(self.dim_z_unit + 5*self.dim_z_unit**2) ) # 5 is pre-defined locality
    ...
    def forward(self, x):
        ...
        # unitNet1 is taking the input (N, 20, 3)
        ...
        out2 = self.unitNet2_param.repeat([batch_size, dim_u2, 1])
...
# torch.save(cgkn.state_dict(), path_abs + r"/Models/Model_KoopmanLinear/L94(40)_KoopmanLinear_dimzunit6_stage1.pt")
# np.save(path_abs + r"/Models/Model_KoopmanLinear/L94(40)_KoopmanLinear_dimzunit6_train_loss_forecast_history_stage1.npy", train_loss_forecast_history)
# np.save(path_abs + r"/Models/Model_KoopmanLinear/L94(40)_KoopmanLinear_dimzunit6_train_loss_ae_history_stage1.npy", train_loss_ae_history)
# np.save(path_abs + r"/Models/Model_KoopmanLinear/L94(40)_KoopmanLinear_dimzunit6_train_loss_forecast_z_history_stage1.npy", train_loss_forecast_z_history)

cgkn.load_state_dict(torch.load(path_abs + r"/Models/Model_KoopmanLinear/L94(40)_KoopmanLinear_dimzunit6_stage1.pt"))
...
# torch.save(cgkn.state_dict(), path_abs + r"/Models/Model_KoopmanLinear/L94(40)_KoopmanLinear_dimzunit6_stage2.pt")
# np.save(path_abs + r"/Models/Model_KoopmanLinear/L94(40)_KoopmanLinear_dimzunit6_train_loss_forecast_history_stage2.npy", train_loss_forecast_history)
# np.save(path_abs + r"/Models/Model_KoopmanLinear/L94(40)_KoopmanLinear_dimzunit6_train_loss_da_history_stage2.npy", train_loss_da_history)
# np.save(path_abs + r"/Models/Model_KoopmanLinear/L94(40)_KoopmanLinear_dimzunit6_train_loss_ae_history_stage2.npy", train_loss_ae_history)
# np.save(path_abs + r"/Models/Model_KoopmanLinear/L94(40)_KoopmanLinear_dimzunit6_train_loss_forecast_z_history_stage2.npy", train_loss_forecast_z_history)

cgkn.load_state_dict(torch.load(path_abs + r"/Models/Model_KoopmanLinear/L94(40)_KoopmanLinear_dimzunit6_stage2.pt"))
...
# np.save(path_abs + r"/Data/L96(40)_KoopmanLinear_dimzunit5_test_u_leadPred0u2(400uTo450u).npy", test_u_leadPred)
