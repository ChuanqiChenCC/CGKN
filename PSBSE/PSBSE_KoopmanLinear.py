...
torch.save(cgkn.state_dict(), path_abs + r"/Models/Model_KoopmanLinear/PSBSE_KoopmanLinear_dimz12_stage1.pt")
np.save(path_abs + r"/Models/Model_KoopmanLinear/PSBSE_KoopmanLinear_dimz12_train_loss_forecast_history_stage1.npy", train_loss_forecast_history)
np.save(path_abs + r"/Models/Model_KoopmanLinear/PSBSE_KoopmanLinear_dimz12_train_loss_ae_history_stage1.npy", train_loss_ae_history)
np.save(path_abs + r"/Models/Model_KoopmanLinear/PSBSE_KoopmanLinear_dimz12_train_loss_forecast_z_history_stage1.npy", train_loss_forecast_z_history)
...
torch.save(cgkn.state_dict(), path_abs + r"/Models/Model_KoopmanLinear/PSBSE_KoopmanLinear_dimz12_stage2.pt")
np.save(path_abs + r"/Models/Model_KoopmanLinear/PSBSE_KoopmanLinear_dimz12_train_loss_forecast_history_stage2.npy", train_loss_forecast_history)
np.save(path_abs + r"/Models/Model_KoopmanLinear/PSBSE_KoopmanLinear_dimz12_train_loss_da_history_stage2.npy", train_loss_da_history)
np.save(path_abs + r"/Models/Model_KoopmanLinear/PSBSE_KoopmanLinear_dimz12_train_loss_ae_history_stage2.npy", train_loss_ae_history)
np.save(path_abs + r"/Models/Model_KoopmanLinear/PSBSE_KoopmanLinear_dimz12_train_loss_forecast_z_history_stage2.npy", train_loss_forecast_z_history)
...
with torch.no_grad():
    test_u_extended_pred = torchdiffeq.odeint(cgkn, test_u_extended0, train_t[:2])[-1]
...
np.save(path_abs + r"/Data/PSBSE_KoopLinear_dimz10_test_mu_pred.npy", test_mu_pred)
np.save(path_abs + r"/Data/PSBSE_KoopLinear_dimz10_test_mu_std_pred.npy", test_mu_std_pred)
